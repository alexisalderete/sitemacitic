...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a class="active" href="<?php echo URL;?>pagos-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO PAGO</a>
        </li>
        <li>
...
<div class="container-fluid">
    ...
    <div class="container-fluid form-neon">
        ...
        <fieldset>
            ...
            <?php if(empty($_SESSION['datos_inscripciones'])){ ?>
                <span class="text-danger">&nbsp; <i class="fas fa-exclamation-triangle"></i> Seleccione una inscripción</span>
                <br>
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#Modalinscripciones"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar estudiantes inscriptos</button>
            ...
            <form class="FormularioAjax" action="<?php echo URL;?>ajax/pagosAjax.php" method="POST" data-form="pagos">
                <input type="hidden" name="id_eliminar_inscripciones" value="<?php echo $_SESSION['datos_inscripciones']['ID']; ?> ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    <label for="cursos_nombre" class="bmd-label-floating">Código de inscripción</label>
                                    <input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,140}" class="form-control" maxlength="140"
                                    value="<?php echo $_SESSION['datos_inscripciones']['Codigo']; ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,140}" class="form-control" maxlength="140"
                                    value="<?php echo $_SESSION['datos_inscripciones']['Nombre'].' '. $_SESSION['datos_inscripciones']["Apellido"];  ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,140}" class="form-control" maxlength="140"
                                    value="<?php echo $_SESSION['datos_inscripciones']['NombreCurso']; ?>" readonly>
                                </div>
                            </div>
                ...
                <button type="submit" class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i> Remover inscripción</button>
    ...
    ?>
        ...
        <?php if(!empty($_SESSION['datos_inscripciones'])){ ?>
        <button type="button" class="btn btn-primary btn-sm" onclick="agregar_conceptos_incripciones(<?php echo $_SESSION['datos_inscripciones']['ID']?>)"><i class="fa-solid fa-plus"></i> Agregar inscripción</button>
        ...
        <form class="FormularioAjax" action="<?php echo URL;?>ajax/pagosAjax.php" method="POST" data-form="guardar">
            ...
            <input type="hidden" name="codigo_agregar_pagos" value="<?php echo $_SESSION['datos_inscripciones']['Codigo']; ?>">
            <fieldset>
                ...
                <div class="container-fluid" id="tabla_conceptos">
                    <div class="table-responsive-1">
                        <table class="table table-hover table-sm">
                            ...
                            <?php
                                echo $ins_pagos -> datos_cuotas_controlador($_SESSION['datos_inscripciones']['ID']);
                            ?>
...
<!-- MODAL INSCRIPCIONES -->
<div class="modal fade" id="Modalinscripciones" tabindex="-1" role="dialog" aria-labelledby="Modalinscripciones" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="Modalinscripciones">Buscar estudiantes inscriptos</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="form-group">
                        <label for="input_inscripciones" class="bmd-label-floating">Buscar estudiante por nombre, apellido o N° CI</label>
                        <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" name="input_inscripciones" id="input_inscripciones" maxlength="30">
                    </div>
                </div>
                <br>
                <!-- los datos de esta tabla esta en el controlador de inscripcionesControlador en la funcion buscar_inscripciones_inscripciones_controlador() -->
                <div class="container-fluid" id="tabla_inscripciones"></div>
                
            </div>
            <!-- onclick="buscar_inscripciones()" para que ejecute la funcion del archivo inc/inscripciones.php -->
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-sm" onclick="buscar_inscripciones()"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar</button>
                &nbsp; &nbsp;
                <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Cerrar</button>
            </div>
        </div>
