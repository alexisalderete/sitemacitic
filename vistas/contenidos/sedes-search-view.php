...
<div class="full-box page-header">
    <h3 class="text-left">
        <i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR sedes
    </h3>
...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo URL;?>sedes-search/"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR SEDES</a>
        </li>
    </ul>	
</div>
...
<?php
    ...
    // y sedes porque es el value del modulo en el formulario <input type="hidden" name="modulo" value="sedes">
    if (!isset($_SESSION['busqueda_sedes']) && empty($_SESSION['busqueda_sedes']) ){ //si no esta difinida o no existe
?>
...
<div class="container-fluid">
    <form class="form-neon FormularioAjax" action="<?php echo URL; ?>ajax/buscadorAjax.php" method="POST" data-form="default" autocomplete="off">
        <input type="hidden" name="modulo" value="sedes">
        <div class="container-fluid">
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="inputSearch" class="bmd-label-floating">¿Qué SEDE estas buscando?</label>
            ...
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-6">
                    <p class="text-center" style="font-size: 20px;">
                        Resultados de la busqueda <strong>“<?php echo $_SESSION['busqueda_sedes'];?>”</strong>
                    </p>
                </div>
                <div class="col-12">
                    <p class="text-center">
...
<?php
        ...
        $pagina[0], $_SESSION['busqueda_sedes']);
    ?>
</div>
