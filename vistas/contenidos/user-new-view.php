...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        <li>
            <a class="active" href="<?php echo URL;?>user-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO USUARIO</a>
        </li>
        <li>
...
<!-- Content -->
<div class="container-fluid">
    <!-- data-form="guardar" para que aparezca un mensaje que los datos se van a guardar -->
    <form class="form-neon FormularioAjax" action="<?php echo URL?>ajax/usuarioAjax.php" method="POST" data-form="guardar" autocomplete="off">
        <fieldset>
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[0-9\-]{6,10}" class="form-control" name="usuario_dni_reg" id="usuario_dni" maxlength="20" >
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="usuario_clave_1_reg" id="usuario_clave_1" pattern="[a-zA-Z0-9$@.\-]{8,100}" maxlength="100" ="" >
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="usuario_clave_2" class="bmd-label-floating">Repetir contraseña</label>
                            <input type="password" class="form-control" name="usuario_clave_2_reg" id="usuario_clave_2" pattern="[a-zA-Z0-9$@.\-]{8,100}" maxlength="100" ="" >
                        </div>
                    </div>
                </div>
            </div>
